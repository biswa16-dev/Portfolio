                  ...
                  {activeExperienceTab === 'Professional' ? (
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="p-8 rounded-3xl border border-white/10 bg-black/40 hover:border-white/20 transition-colors">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-xl overflow-hidden shrink-0 shadow-lg border border-white/10 bg-white flex items-center justify-center">
                              <img src="/adobe.png" alt="Adobe Logo" className="w-full h-full object-contain" />
                            </div>
                            <div>
